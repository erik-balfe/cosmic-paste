...
**Independent software.** Not affiliated with System76 or the official COSMIC application set. Built for personal use on COSMIC; shared in the hope it helps other desktop users.

## Mission

Build a stable, maintainable clipboard manager that follows COSMIC APIs, design language, and coding conventions — quality software for the desktop, with a long-term aspiration to propose it upstream if it earns that place.
...
- **Public repo quality:** clean tree, CI green, honest docs (limitations + non-official status), correct packaging stubs.
...
- Public-readiness: untrack local `AGENTS.md`, scrub personal paths, README/STATE disclaimers
...
- Upstream proposal to COSMIC maintainers after Phase 2 polish (if quality bar is met)
...
- Manual review pass on COSMIC (install, shortcuts, persistence across reboot) — deferred until after publish decision
